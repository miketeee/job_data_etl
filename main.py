...
if __name__ == '__main__':
    ...
    rf = read_file("rawJobData.csv")

    strings_to_lower_case = char_case.transfrom_all_to_lowercase(rf)
    ...
    indices_that_only_contain_word_new_removed = match_index.remove_indices_that_contain_only_the_word_new(empty_indices_removed)
    jobs_starting_indices = double_quotes.detect_if_double_quote_exists_at_beggining_of_string(indices_that_only_contain_word_new_removed)
    strings_sliced_into_individual_lists = slice_operations.slice_list_of_jobs_into_individual_jobs(indices_that_only_contain_word_new_removed, jobs_starting_indices)
    jobs_with_cleaned_location = location.clean_location_data_to_show_city_only(strings_sliced_into_individual_lists)
    ...
    jobs_with_current_date_added = search_date.add_todays_date_to_job_data(jobs_with_cleaned_title)
    jobs_ready_for_loading_into_db = jobs_with_current_date_added
